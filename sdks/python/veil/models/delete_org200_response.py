...
class DeleteOrg200Response(BaseModel):
    """
    ...
    humans: Optional[StrictInt] = None
    keys: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["items", "grants", "sessions", "agents", "humans", "keys"]
