...
class InviteResponse(BaseModel):
    ...
    emailed: StrictBool
    recovery_url: Optional[StrictStr] = Field(default=None, description="Only present when mail delivery is not configured (local dev).")
    __properties: ClassVar[List[str]] = ["identity_id", "emailed", "recovery_url"]
