 ...
 */
export declare const streamRequests: <ThrowOnError extends boolean = false>(options?: Options<StreamRequestsData, ThrowOnError, StreamRequestsResponse>) => Promise<ServerSentEventsResult<StreamRequestsResponses>>;
/**
 ...
 */
export declare const getBilling: <ThrowOnError extends boolean = false>(options?: Options<GetBillingData, ThrowOnError>) => RequestResult<GetBillingResponses, GetBillingErrors, ThrowOnError>;
/**
 ...
 */
export declare const billingWebhook: <ThrowOnError extends boolean = false>(options: Options<BillingWebhookData, ThrowOnError>) => RequestResult<BillingWebhookResponses, BillingWebhookErrors, ThrowOnError>;
