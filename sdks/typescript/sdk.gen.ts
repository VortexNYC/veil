 ...
 */
export const streamRequests = <ThrowOnError extends boolean = false>(options?: Options<StreamRequestsData, ThrowOnError, StreamRequestsResponse>): Promise<ServerSentEventsResult<StreamRequestsResponses>> => (options?.client ?? client).sse.get<StreamRequestsResponses, StreamRequestsErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const denyRequest = <ThrowOnError extends boolean = false>(options: Options<DenyRequestData, ThrowOnError>): RequestResult<DenyRequestResponses, DenyRequestErrors, ThrowOnError> => (options.client ?? client).post<DenyRequestResponses, DenyRequestErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
